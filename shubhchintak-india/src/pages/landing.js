...
import Graphic from "./graphicdesigndev";
function ok() {}
function landing() {
  return (
    <div>
      ...
      >
        <h1 className="relative mt-[8%] text-center text-white font-xyz text-[60px]">
          We are bringing
        </h1>
        <h1 className="relative text-center text-[#0F89FF] font-xyz text-[60px]">
          DIGITAL TRANSFORMATION
        </h1>
        <p className="relative text-center text-white text-[16px] ml-[20%] mr-[20%]">
          Future is for those who work for their dreams. Our deep knowledge and
          expertise in providing digital solutions help the dreamers to take
          step forward to start with their dream business ideas.We accompany
          them at every step to leverage innovation and advancement as per the
      ...
      >
        <h1 className="text-white text-center text-[40px]">
          Our successful work deliveries make us worthy!
        </h1>
        <p className="text-white text-center font-[16px] ml-[23%] mr-[23%]">
          We can proudly say that we have delivered our projects with almost 99%
          of customer satisfaction.We strongly believe that for bringing digital
          transformation it is very important to create a global impact. We are
          open for serving entire business community globally with our
          expertise.
        </p>
        <div className="space-x-10 flex flex-row mt-[2%] ml-[10%] mr-[10%] border-2 rounded-md border-solid pb-[6%] bg-black-rgba">
          <div className="ml-[12%] mt-[5%]">
            ...
            <p className="text-[18px] text-xyz text-white">
              Projects Delivered
            </p>
          </div>
          <div className="mt-[5%]">
      ...
      <div className="bg-gradient-to-r from-blue-400 to-purple-400 pt-[2%]">
        <h2 className="ml-[10%] text-[30px] text-white">
      ...
      >
        <div className=" ml-[10%] mr-[10%] pt-[5%]">
          <div className="bg-black-rgba pt-[2%] pb-[2%]">
            <h1 className="text-[30px] text-white font-xyz text-center">
      ...
      <div style={{ backgroundImage: `url(${bg.src})` }}>
        <div className="pt-[5%] ml-[10%] mr-[10%]">
          <div className="mt-[5%]">
            <h1 className="text-white text-center font-abc text-[40px]">
          ...
          <div className="flex flex-row mt-[3%]">
            <div className="mr-[20%]">
              ...
              <p className="text-white text-left text-[16px]">
                Lorem ipsum dolor sit amet consectetur. Amet in bibendum mattis
                amet aliquam risus elementum sapien gravida. Accumsan sit
                ultrices in sapien enim. Magna venenatis non egestas pulvinar
                vel pellentesque sagittis. Eget eleifend nunc nec id leo id
                blandit sem.
              </p>
