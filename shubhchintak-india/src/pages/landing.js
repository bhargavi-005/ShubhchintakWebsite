    ...
    >
      ...
      >
        <div className="flex flex-col justify-center items-center">
          <h1 className="max-[768px]:text-[35px] relative mt-[8%] text-center font-extrabold text-white font-xyz text-[60px]">
            We are bringing
          </h1>
          <h1 className="max-[768px]:text-[35px] relative text-center font-extrabold text-[#0F89FF] font-xyz text-[60px]">
            DIGITAL TRANSFORMATION
          </h1>
          <p className="max-[768px]:text-[14px] max-[768px]:ml-[3%] max-[768px]:mr-[3%] font-medium relative text-center text-white text-[16px] ml-[20%] mr-[20%]">
            Future is for those who work for their dreams. Our deep knowledge
            and expertise in providing digital solutions help the dreamers to
            take step forward to start with their dream business ideas.We
            accompany them at every step to leverage innovation and advancement
            as per the latest market trends.
          </p>
          <p className="relative text-center text-white text-[16px] ml-[20%] mr-[20%]">
            We identify their challenge ,guide them, create effective work
            strategy, develop their complex business ideas and deploy it as
            earliest as possible with the help of our expert team.
          </p>
          ...
          <button class="max-[768px]:w-[300px]  max-[768px]:h-[50px] mt-[3%] bg-blue-500 hover:bg-blue-700 text-white font-bold h-[50px] w-[400px]  rounded-full">
            <p className="max-[768px]:text-[15px] max-[768px]:w-[300px]">
        ...
        <div className="max-[768px]:hidden max-[768px]:flex max-[768px]:flex-col flex flex-row mt-[1%] ml-[10%] space-x-5">
          <div className="">
            <button
              ...
              class="dot bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full"
            >
              Website
            </button>
          </div>
          <div className="">
            <button
              ...
              class="max-[768px]:mt-[2%] max-[768px]:ml-[34%] bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full"
            >
              Mobile App
            </button>
          </div>
          <div>
            <button
              ...
              class="max-[768px]:mt-[2%] max-[768px]:ml-[27%] bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full"
            >
              Cloud Consulation
            </button>
          </div>
          <div>
            <button
              ...
              class="max-[768px]:mt-[2%] max-[768px]:ml-[30%] bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full"
            >
              Graphic Design
            </button>
          </div>
          <div>
            <button
              ...
              class="max-[768px]:mt-[2%] max-[768px]:ml-[32%] bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full"
            >
              UI/UX Design
            </button>
          </div>
          ...
          <div>
            <button
              ...
              class="max-[768px]:mt-[2%] max-[768px]:ml-[29%] bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full"
            >
              Manual Testing
            </button>
          </div>
          <div>
            <button
              ...
              class="max-[768px]:mt-[2%] max-[768px]:ml-[39%] bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full"
            >
              VR/AR
            </button>
          </div>
      ...
      {/* Next Section */}
      <div style={{ backgroundImage: `url(${bg.src})` }}>
        <h1 className="mt-[3%] text-white text-center text-[40px] font-semibold">
        ...
        <div className="mt-[5%] max-[768px]:flex max-[768px]:flex-col flex flex-row justify-evenly ml-[8%] mr-[8%]">
          <div className="max-[768px]:ml-[-8%]  bg-[#FFFFFF1A] max-[768px]:w-[115%] w-[400px] h-[450px] justify-center items-center">
            ...
            <div className="bg-black-rgba h-[173px] w-[100%]">
              ...
              <p className="mt-[2%] ml-[1%] text-white text-[16px] font-xyz">
                It all started with one big computer coming into existence.
              </p>
              <a href="#" className="text-white text-[16px] ml-[1%]">
                Read More
              </a>
            </div>
          </div>
          <div className="max-[768px]:ml-[-8%] max-[768px]:w-[115%] max-[768px]:mt-[5%] bg-[#FFFFFF1A] w-[400px] h-[450px]">
            ...
            <div className=" max-[768px]:mr-[5%] bg-black-rgba h-[173px] w-[100%]">
              ...
              <p className="mt-[2%] ml-[1%] text-white text-[16px] font-xyz">
                Designing good looking posters and social media posts is not as
                hard as it sounds.
              </p>
              <a href="#" className="text-white text-[16px] ml-[1%]">
                Read More
