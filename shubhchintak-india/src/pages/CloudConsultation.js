    ...
    <>
      ...
      >
        <div className="p-4 md:p-6 lg:p-16">
          ...
          <section>
            <div className="flex flex-col w-full lg:p-6 content-center justify-items-center mt-24">
              ...
              <div className="text-white mt-8 lg:m-6 text-base md:text-2xl text-center">
          ...
          <section>
            <div className="text-3xl md:text-5xl lg:text-6xl  text-white p-4 md:p-4 lg:p-12 font-bold text-center ml-0 mr-0 md:ml-6 md:mr-6 lg:ml-32 lg:mr-32">
              ...
              <span className="text-blue-500">
                {" 360'"}{" "}
                <span className="lg:mt-2 md:mt-2 mt-0">
                  Cloud Consultancy Process!
                </span>
              </span>
            </div>
          ...
          <section>
            <div>
              ...
              <div className="item-center justify-center flex flex-col md:flex-row mt-5">
          ...
          <section>
            <div className="lg:mt-5 mt-4 ml-10">
