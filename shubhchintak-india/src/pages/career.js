...
function career() {
    return(
        <div className="max-[768px]:pr-[20%]" style={{ backgroundImage: `url(${bg.src})` }} >
            <Header/>
            <div className=" flex flex-row max-[768px]:flex max-[768px]:flex-col ">
                <div className=" ml-[8%]  max-[768px]:order-last  mr-[30%] mt-[13%]">
                    <h1 className="max-[768px]:w-[150%] max-[768px]:ml-[15%] max-[768px]:text-center max-[768px]:text-[35px] text-[60px] font-xyz font-extrabold text-white">Build your career with Us!</h1>
                    <p className="max-[768px]:ml-[25%] max-[768px]:text-center max-[768px]:mr-[-50%] text-[18px] font-xyz font-semibold text-white">Our employees are the assets of our organization. We do 
                ...
                <div className="max-[768px]:flex max-[768px]:justify-center max-[1500px]:mr-[10%] max-[768px]:w-[120%] w-[100%] ml-[-18%] mt-[5%] max-[768px]:ml-[3%] max-[768px]:order-first ">
                    <Image className="max-[768px]:h-[300px] max-[768px]:w-[90%] w-[600px] h-[500px] "
            ...
            <div className="max-[768px]:flex max-[768px]:justify-center max-[1500px]:mr-[10%] max-[768px]:w-[120%] w-[100%] ml-[-18%] mt-[5%] max-[768px]:ml-[3%] max-[768px]:order-first ">
                ...
                <div className="max-[768px]:flex max-[768px]:flex-col flex flex-row  mt-[3%]">
                    <div className=" mr-[10%] max-[768px]:order-last max-[768px]:mr-[5%]">
                        <h1 className="max-[1500px]:ml-[25%] text-white text-[40px] font-semibold max-[768px]:text-[35px] max-[768px]:w-[100%] max-[768px]:text-center">Benefits of working with Us!</h1>
                        <p className="max-[1500px]:ml-[25%] max-[768px]:w-[100%] text-white text-left text-[16px]  max-[768px]:text-center">We believe when employees feel fulfilled and see their growth potential in their job, they start loving their job. Here are some reasons for working with us;</p>
                        <div className="max-[1500px]:ml-[15%]  max-[768px]:ml-[30%] max-[768px]:text-center  flex flex-row mt-[5%]">
                            <div>
                                <Image className="max-[768px]:w-[80px]"
                        ...
                        <div className="max-[768px]:ml-[30%] max-[768px]:text-center max-[1500px]:ml-[15%]  flex flex-row mt-[5%]">
                            <div>
                                <Image className="max-[768px]:w-[55px]"
                                src="/images/ticks.png"
                                alt="career"
                                width={20}
                                height={20}/>
            ...
            <div className="max-[768px]:mt-[20%] max-[768px]:ml-[15%]  ml-[4%] mr-[4%] relative mt-[10%]">
                <h1 className="text-center text-white text-[40px] max-[768px]:text-[30px] max-[768px]:mr-[-20%] font-semibold">Current openings!</h1>
