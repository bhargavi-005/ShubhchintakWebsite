    ...
    return(
        <div className="box-border text-white mx-5 md:mx-12 lg:mx-28  "  >
            ...
            <div className="flex flex-col justify-center items-center text-center mt-[80px]">
                ...
                <p className="font-xyz font-medium text-sm mt-8 md:text-xl lg:w-[1350px]">Our company has years of experience in developing mobile applications for various platforms, including iOS, Android, and cross-platform solutions. We have successfully completed numerous projects for clients from diverse industries, ranging from small startups to large enterprises.We understand that every business has unique requirements, and that's why we provide customized app development solutions tailored to your specific needs. Our team works closely with you to understand your business goals and objectives, and then develops an app that aligns with your vision.</p>
            ...
            <div className="grid grid-col-2 place-items-center  md:grid-cols-2 lg:grid-cols-3  lg:gap-x-0 items-center gap-4 my-10  "> 
                    ...
                    <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Backend</div>
                    <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Android App</div>
                    <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">App User Interface</div>
            </div>
