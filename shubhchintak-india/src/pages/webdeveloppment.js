      ...
      <div className="box-border font-xyz text-white  max-[1500px]:overflow-x-hidden">
        ...
        <div className=" flex justify-center items-center text-center  flex-col my-[30px] gap-8 mx-5">
          ...
          <p className="font-xyz text-sm md:text-xl font-medium  lg:w-[1250px] ">
            Creating high end, most engaging Next Gen user experiences through
            our expertise in Web Development Solutions for your Unique Online
            Business Ideas.
          </p>
        ...
        <div className=" flex justify-center items-center text-center mt-[80px] flex-col gap-9 mx-5 font-xyz">
          ...
          <p className="font-xyz text-sm md:text-xl font-medium lg:w-[1250px] ">
            We believe in providing top quality web development solutions for
            our clients. With acceptance of advance technology and prominent
            experience in the industry in providing successful digital
            solutions, we perform both front end and back end built for web
            development. We discuss, design, develop and deploy client based,
            goal and growth oriented web solutions. We have created websites for
            most challenging business ideas, this makes us different.
          </p>
        </div>
