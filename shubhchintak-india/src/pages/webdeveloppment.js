  ...
  return (
    <div className="box-border text-white mx-5 md:mx-12 lg:mx-28  "  >
      ...
      <div className=" flex justify-center items-center text-center  flex-col gap-9">
        <div className="font-[Roboto] font-extrabold text-[40px] md:text-[60px]">Website Development</div>
        <p className="font-xyz text-sm md:text-xl font-medium  lg:w-[1250px] ">Creating high end, most engaging Next Gen user experiences through our expertise in Web Development Solutions for your Unique Online Business Ideas.</p>
        <button className="w-[111px] h-[37px] bg-[#0F89FF] rounded-full text-sm">Get Started</button>
      </div>
      

      <div className=" flex justify-center items-center text-center mt-[80px] flex-col gap-9">
        <div className=" font-bold text-[25px] md:text-[40px] lg:text-[60px] lg:w-[1550px] "><span className="text-[#0F89FF] font-bold text-[25px] md:text-[40px] lg:text-[60px] lg:w-[1550px]">Hire India's top Web development Company</span> to create your Next Gen Web development Solutions!</div>
        <p className="font-xyz text-sm md:text-xl font-medium lg:w-[1250px] ">We believe in providing top quality web development solutions for our clients. With acceptance of advance technology and prominent experience in the industry in providing successful digital solutions, we perform both front end and back end built for web development. We discuss, design, develop and deploy client based, goal and growth oriented web solutions. We have created websites for most challenging business ideas, this makes us different.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  place-items-center  my-20 lg:mx-28 gap-y-6 font-xyz">
            ...
            <div className="w-[320px] h-[135px] md:w-[334px] md:h-[135px] lg:w-[400px] lg:h-[135px]   bg-gradient-to-b from-white to-black flex justify-center items-center  rounded-[4px]">
                ...
                <h6 className="text-xl mx-2">Focus on ROI and retention
                rate improvement</h6>
                </div>
            </div>
            <div className="w-[320px] h-[135px] md:w-[334px] md:h-[135px] lg:w-[400px] lg:h-[135px]   bg-gradient-to-b from-white to-black flex justify-center items-center  rounded-[4px]">
      ...
      <div className="flex justify-center items-center text-center mt-[80px]">
            ...
            <span className="text-[#0F89FF] font-bold text-[25px] md:text-[40px] lg:text-[60px] lg:w-[1550px]"> Right Web Development Solution as per the industry!</span></div>
      </div>
      <Carousel2/>
      ...
      <div className="grid content-center place-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3  lg:gap-x-0 items-center gap-4 my-12  "> 
            <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Front-end web development</div>
            <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Back-end development</div>
            <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Saas Web Application development</div>
            <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Feature rich web apps</div>
            <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Ecommerce web apps</div>
            <div className="bg-white w-fit h-fit text-black rounded-full p-5 text-base md:text-[20px] lg:text-[26px] font-semibold text-center">Custom web development services</div>
      </div>
      ...
      <div className="flex justify-center items-center">
        <div className="w-auto h-[250px] lg:w-[1240px] bg-gradient-to-r from-white to-black flex justify-center items-center  rounded-[4px] my-20">
            <div className="w-[348px] h-[247px] md:w-[721px] lg:w-[1237px] px-3 bg-gray-950 font-semibold text-xl md:text-2xl lg:text-3xl text-center flex flex-col justify-center items-center rounded-[4px] gap-10">Need complete Web development
            consultation?
