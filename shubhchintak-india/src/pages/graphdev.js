...
function graph() {
  return (
    ...
    <div className=" max-[768px]:flex max-[768px]:flex-col flex flex-row ">
        ...
        <h1 className="font-extrabold max-[768px]:ml-[5%] max-[768px]:text-center text-left ml-[18%] max-[768px]:text-[30px] text-white text-[50px] max-[768px]:w-[120%] font-xyz">Graphic Designing</h1>
        <p className="max-[768px]:text-center max-[768px]:ml-[28%] ml-[18%] mr-[%] text-white text-left max-[768px]:text-[14px] text-[20px]">At Shubhchintak Technology, a design is more than just an art. It is treated as an integral part of visual communication that helps cement brands, whether a startup or an established enterprise, in the minds of the target audience. We are known for our best graphics designs in the market.</p>
        <a href="">
        <button class=" max-[768px]:ml-[70%] right-[26%] mt-[2%] max-[768px]:w-[150px] relative bg-white hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full">
         View More
        </button>
