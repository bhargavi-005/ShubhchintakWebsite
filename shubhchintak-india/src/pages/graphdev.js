...
function graph() {
  return (
    ...
    <div className=" max-[768px]:flex max-[768px]:flex-col flex flex-row ">
        ...
        <h1 className="font-extrabold max-[768px]:text-center text-left ml-[18%] max-[768px]:text-[30px] text-white text-[50px] max-[768px]:w-[120%] font-xyz">Graphic Designing</h1>
