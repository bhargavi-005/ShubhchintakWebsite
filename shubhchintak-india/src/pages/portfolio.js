    ...
    return(
        <div style={{ backgroundImage: `url(${bg.src})` }} className="max-[768px]:overflow-x-hidden">
            ...
            <div className="w-[100%] h-[30%]  relative">
                ...
                width={1660}
                height={600}/>
                <h1 className="max-[768px]:text-[30px] max-[768px]:ml-[10%] max-[768px]:w-[80%] mt-[10%] text-center absolute top-0 ml-[15%] mr-[15%] text-white font-xyz text-[60px] font-extrabold">From startups to enterprises, we 
                    have no limits, we serve all!</h1>
                    <p className="max-[768px]:mt-[58%] max-[768px]:ml-[10%] max-[768px]:w-[80%] max-[1500px]:mt-[25%] text-[16px] text-center absolute top-0 ml-[25%] mr-[25%] text-white font-xyz mt-[23%]">We have helped our clients in building digital solutions as per their business needs. We understood their 
