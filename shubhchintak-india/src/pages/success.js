...
function success(){
    return(
        <div className="max-[768px]:mt-[20%] pt-[3%] pb-[2%]" >
            ...
            <div className="max-[768px]:flex max-[768px]:flex-col space-x-10 flex flex-row mt-[2%] ml-[10%] mr-[10%] border-2 rounded-md border-solid pb-[6%] bg-black-rgba">
