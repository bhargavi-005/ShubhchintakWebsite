...
function success(){
    return(
        <div className="max-[768px]:mt-[60%] pt-[3%] pb-[2%]" style={{ backgroundImage: `url(${bg.src})` }} >
            <h1 className="text-white text-center text-[40px]">Our successful work deliveries make us worthy!</h1>
            <p className="max-[768px]:ml-[5%] max-[768px]:mr-[5%] text-white text-center font-[16px] ml-[23%] mr-[23%]">We can proudly say that we have delivered our projects with almost 99% of customer satisfaction.We strongly believe that for bringing digital transformation it is very important to create a global impact. We are open for serving entire business community globally with our expertise.</p>
            <div className="max-[768px]:flex max-[768px]:flex-col ml-[10%] mr-[10%] space-x-10 flex flex-row mt-[2%] justify-center items-center border-2 rounded-md border-solid pb-[6%] bg-black-rgba">
                <div className=" mt-[5%] justify-center items-center">
                    <h2 className="max-[768px]:ml-[25%] text-[40px] text-center text-xyz text-white">80+</h2>
