                ...
                <ul>
                  <li className=" mb-4 flex flex-row text-white">
                    ...
                    <div className="font-xyz text-sm font-medium  ">
                      <span className="text-[#0F89FF]">Problem addressed:</span>{" "}
                  ...
                  <li className=" mb-4 flex flex-row">
                    ...
                    <div className="font-xyz text-sm font-medium ">
                      <span className="text-[#0F89FF]">Key features: </span>The
                      store sells accessories and daily necessary goods made of
                      bamboo, promoting a sustainable and organic lifestyle.
                    </div>
                  </li>
